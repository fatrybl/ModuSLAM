...
path1 = dir / "lidars.ply"
path2 = dir / "lidars_imu.ply"
path3 = dir / "lidars_imu_gps.ply"
...
cloud = o3d.io.read_point_cloud(path3.as_posix())
...
ctr.set_lookat([0, 0, 0])  # Set the camera's target position (X, Y, Z)
ctr.set_up(up_rotated)  # Set rotated up vector
ctr.set_zoom(0.40)  # Adjust the zoom level
