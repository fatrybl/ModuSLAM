...
def test_2_measurements_1_cluster(empty_graph: Graph):
    m1 = Odometry(1, TimeRange(0, 1), i4x4, i3x3, i3x3)
    m2 = Odometry(1, TimeRange(0, 1), i4x4, i3x3, i3x3)
...
def test_2_measurements_2_clusters(empty_graph: Graph):
    m1 = Odometry(1, TimeRange(0, 1), i4x4, i3x3, i3x3)
    ...
    clusters = empty_graph.vertex_storage.clusters
