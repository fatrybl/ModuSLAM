...
from slam.frontend_manager.handlers.vrs_gps import VrsGpsPreprocessor
...
class LidarsImuGpsAnalyzer(StateAnalyzer):
    ...
    def evaluate(self, measurements: OrderedSet[Measurement]) -> State | None:
        ...
        if isinstance(m.handler, (ScanMatcher, VrsGpsPreprocessor)):
