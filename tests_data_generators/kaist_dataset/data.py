...
class Data:
    def __init__(self, directory: Path):
        ...
        self.imu = Sensor(SensorConfig(imu_name))
        self.fog = Sensor(SensorConfig(fog_name))
        self.encoder = Sensor(SensorConfig(encoder_name))
        self.altimeter = Sensor(SensorConfig(altimeter_name))
        self.gps = Sensor(SensorConfig(gps_name))
        self.vrs_gps = Sensor(SensorConfig(vrs_gps_name))
        self.sick_back = Sensor(SensorConfig(sick_back_name))
        self.sick_middle = Sensor(SensorConfig(sick_middle_name))
        self.velodyne_left = Sensor(SensorConfig(velodyne_left_name))
        self.velodyne_right = Sensor(SensorConfig(velodyne_right_name))
        self.stereo = Sensor(SensorConfig(stereo_name))
