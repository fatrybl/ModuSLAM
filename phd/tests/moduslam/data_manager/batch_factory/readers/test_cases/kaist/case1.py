...
valid_stream_scenarios = (
    ...
    (sensors_factory_config4, dataset_cfg, stream, KaistReader, [el19, el22, el24, None]),
    (sensors_factory_config5, dataset_cfg, stream, KaistReader, [el5, el14, el25, None]),
    (sensors_factory_config5, dataset_cfg, stream, KaistReader, [el5, el14, el25, None]),
)
...
valid_timelimit_scenarios = (
    ...
    (sensors_factory_config3, dataset_cfg, timelimit2, KaistReader, [el12, None]),
    (sensors_factory_config4, dataset_cfg, timelimit2, KaistReader, [el19, el22]),
    (sensors_factory_config6, dataset_cfg, timelimit6, KaistReader, [el3, el8, None]),
)
