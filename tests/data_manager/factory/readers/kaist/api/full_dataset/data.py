...
sensor_element_pairs = [
    ...
    SensorElementPair(Encoder(encoder.name, params), el11),
    SensorElementPair(Lidar2D(sick_back.name, params), el2),
    SensorElementPair(Lidar2D(sick_back.name, params), el12),
    SensorElementPair(
        Imu(imu.name, params),
        el3,
    ),
    SensorElementPair(Imu(imu.name, params), el10),
    SensorElementPair(
        Fog(fog.name, params),
        el4,
    ),
    SensorElementPair(Fog(fog.name, params), el21),
    SensorElementPair(Lidar2D(sick_middle.name, params), el5),
    SensorElementPair(Lidar2D(sick_middle.name, params), el14),
    SensorElementPair(Gps(gps.name, params), el6),
    SensorElementPair(Gps(gps.name, params), el13),
    SensorElementPair(VrsGps(vrs_gps.name, params), el7),
    SensorElementPair(VrsGps(vrs_gps.name, params), el18),
    SensorElementPair(Altimeter(altimeter.name, params), el8),
    SensorElementPair(Altimeter(altimeter.name, params), el9),
    SensorElementPair(Lidar3D(velodyne_left.name, params), el15),
    SensorElementPair(Lidar3D(velodyne_left.name, params), el17),
    SensorElementPair(Lidar3D(velodyne_right.name, params), el16),
    SensorElementPair(Lidar3D(velodyne_right.name, params), el20),
    SensorElementPair(StereoCamera(stereo.name, params), el19),
    SensorElementPair(StereoCamera(stereo.name, params), el22),
]
