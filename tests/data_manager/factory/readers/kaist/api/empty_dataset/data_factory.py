...
class DataFactory:
    ...
    el9 = PseudoElement(timestamp=z_velodyne_left_1[0],
                        measurement=Measurement(
    ...
    el10 = PseudoElement(timestamp=z_velodyne_right_1[0],
                         measurement=Measurement(
    ...
    el11 = PseudoElement(timestamp=z_stereo_left_1[0],
    ...
    elements: list[PseudoElement] = [el1, el2, el3,
                                     el4, el5, el6, el7, el8, el9, el10, el11]
    ...
    sensor_element_pairs = [
        ...
        SensorElementPair(velodyne_left, el9),
        SensorElementPair(velodyne_right, el10),
        SensorElementPair(stereo, el11),
    ]
    ...
    def generate_data(self,) -> None:
        ...
        with open(self.DATA_STAMP_FILE, "w"):
            pass

        for __, path in self.stamp_files:
            with open(path, "w"):
                pass
