...
lidar_3D_right = SensorConfig("velodyne_right", Lidar3D.__name__, ParameterConfig())
lidar_3D_left = SensorConfig("velodyne_left", Lidar3D.__name__, ParameterConfig())
...
class BFConfig(BatchFactoryConfig):
    regime: RegimeConfig = field(default_factory=TimeLimitConfig)
