from moduslam.bridge.edge_factories.factory_protocol import VertexWithStatus
from moduslam.bridge.edge_factories.utils import create_vertex_from_previous
