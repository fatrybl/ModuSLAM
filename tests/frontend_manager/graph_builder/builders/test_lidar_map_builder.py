...
class TestLidarMapBuilder:
    def test_create_graph_candidate(self, data_batch, builder, setup_manager):
    ...
    def test_merge_graph_candidate(self, data_batch, builder, setup_manager):
        builder.create_graph_candidate(data_batch)
    ...
    def test_create_graph_candidate_empty_batch(self, builder, setup_manager):
    ...
    def test_merge_graph_candidate_no_candidate(self, builder, setup_manager):
        graph = Graph[LidarPose, LidarOdometry]()
        builder.merge_graph_candidate(graph)
    ...
    def test_clear_candidate(self, data_batch, builder, setup_manager):
        builder.create_graph_candidate(data_batch)
